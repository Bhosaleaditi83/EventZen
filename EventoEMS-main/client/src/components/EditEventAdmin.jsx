...
const EditEventAdmin = ({ close ,data : propsData,fetchProductData}) => {
    const [data, setData] = useState({
      _id : propsData._id,
      name: propsData.name,
      image: propsData.image,
      eventscategory: propsData.eventscategory,
      subCategory: propsData.subCategory,
      event_date : propsData.event_date,
      unit: propsData.unit,
      eventcapacity: propsData.eventcapacity,
    ...
    const handleRemoveCategory = async (index) => {
      data.eventscategory.splice(index, 1)
      setData((preve) => {
        return {
          ...preve
        }
        ...
        <div className='bg-white w-full p-4 max-w-2xl mx-auto rounded overflow-y-auto h-full max-h-[95vh]'>
          <section className=''>
            <div className='p-2   bg-white shadow-md flex items-center justify-between'>
              <h2 className='font-semibold'>Upload Event</h2>
            ...
            <div className='grid p-3'>
              <form className='grid gap-4' onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div>
                    <label htmlFor='eventImage' className='bg-blue-50 h-24 border rounded flex justify-center items-center cursor-pointer'>
                  ...
                  <div>
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        const eventscategory = allCategory.find(el => el._id === value)
  
                        setData((preve) => {
                          return {
                            ...preve,
                            eventscategory: [...preve.eventscategory, eventscategory],
                          }
                        })
                        setSelectCategory("")
                      }}
                    ...
                    <div className='flex flex-wrap gap-3'>
                      {
                        data.eventscategory.map((c, index) => {
                          return (
                ...
                <div className='grid gap-1'>
                  <label htmlFor='eventcapacity' className='font-medium'>Event Capacity</label>
                  <input 
                    id='eventcapacity'
                    type='number'
                ...
                <div className='grid gap-1'>
                  <label htmlFor='price' className='font-medium'>Ticket Price</label>
                  <input
                    id='price'
                    type='number'
